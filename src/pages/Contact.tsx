              ...
              <div className="space-y-6">
                {[
                  { 
                    ...
                    icon: (
                      <svg className="w-4 h-4 text-brand-secondary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div key={idx} className="flex items-start gap-4 transition-premium hover:translate-x-1 group">
                    <div className="w-10 h-10 border border-sand-border bg-white flex items-center justify-center shrink-0 group-hover:bg-brand-secondary group-hover:border-brand-secondary group-hover:text-white transition-colors duration-300">
                      {item.icon}
                    </div>
                    <div>
